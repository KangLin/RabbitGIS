    ...
    ui(new Ui::CDlgAbout)
{
    ...
    QString szHomePage = "https://github.com/KangLin/RabbitGIS";
...
#else
    szFile = CGlobalDir::Instance()->GetDirApplication() + QDir::separator()
            + "ChangeLog.md";
    AppendFile(ui->txtChange, szFile);
    szFile = CGlobalDir::Instance()->GetDirApplication() + QDir::separator()
            + "License.md";
...
void CDlgAbout::on_pbSave_clicked()
{
    ...
    szFile = CTool::FileDialog(this, "QrRabbitGIS.PNG",
