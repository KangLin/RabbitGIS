...
#ifdef RABBITGIS_USE_LIBQRENCODE
#include "qrencode.h"
#endif

#ifdef RABBITGIS_USE_QZXING
    #include "QZXing.h"
#endif

#define RABBITGIS_ID "RABBITGIS://id/"
#define RABBITGIS_USERINFO "RABBITGIS://userinfo/"
...
{  
    ...
    qr = nullptr;
    return image;
#endif //RABBITGIS_USE_LIBQRENCODE
